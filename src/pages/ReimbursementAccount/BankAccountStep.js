...
const BankAccountStep = (props) => {
    ...
    if (subStep === CONST.BANK_ACCOUNT.SETUP_TYPE.MANUAL) {
        return <BankAccountManualStep reimbursementAccount={props.reimbursementAccount} onBackButtonPress={props.onBackButtonPress} />;
    }

    if (subStep === CONST.BANK_ACCOUNT.SETUP_TYPE.PLAID) {
        return <BankAccountPlaidStep reimbursementAccount={props.reimbursementAccount} onBackButtonPress={props.onBackButtonPress} />;
    }
